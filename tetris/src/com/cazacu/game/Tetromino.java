...
public class Tetromino {
    ...
    public static Tetromino J = new Tetromino("001111000", new Vector2(4, 0));
    public static Tetromino L = new Tetromino("100111000", new Vector2(4, 0));
    ...
    public Tetromino(Tetromino t) {
        ...
        this.spawnPos = new Vector2(t.spawnPos);
