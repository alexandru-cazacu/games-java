...
import com.cazacu.engine.core.Renderer;
import com.cazacu.engine.core.Input;
import com.cazacu.engine.core.Game;
import com.cazacu.engine.gfx.Image;
...
public class Main extends Game {
    ...
    private Vector2 fruitPosition = new Vector2(5, 5);
    ...
    public void Update(double dt) {
        ...
        if (Input.isKeyPressed(KeyEvent.VK_W)) {
            snake.moveSnake(new Vector2(0, -1));
        }
        if (Input.isKeyPressed(KeyEvent.VK_A)) {
            snake.moveSnake(new Vector2(-1, 0));
        }
