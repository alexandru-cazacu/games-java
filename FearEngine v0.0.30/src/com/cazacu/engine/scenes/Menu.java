...
public class Menu extends Scene {
	...
	//public Collider mouse = new Collider(new Vector2(50, 50), 1, 1);
	...
	public void Render(Renderer r) {
		...
		r.writeOnScreen("ALPHA v0.0.28", 0xffffffff, new Vector2(0, Renderer.SCREEN_HEIGHT_PX - Font.FONT_SIZE));
	}
}
